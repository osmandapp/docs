...
|   | ![icon-ios](/assets/images/site/icon-ios.png)![icon-android](/assets/images/site/icon-android.png) {% data variables.android-values.route_parameters %}  |  gives a set of settings to [configure routing for selected profile](/osmand/start-with/profiles#configure-routing-for-selected-profile )  |
...
| ![icon-ios](/assets/images/site/icon-ios.png)![icon-android](/assets/images/site/icon-android.png) **{% data variables.android-values.prefer_in_routing_title %}**| **turn on/off**|||
...
|![icon-ios](/assets/images/site/icon-ios.png)![icon-android](/assets/images/site/icon-android.png) **{% data variables.android-values.routing_attr_short_way_name %}** (optimized shorter route for energy saving)| **turn on/off** |||
|   | ✔   |  - | -  |   |
|![icon-ios](/assets/images/site/icon-ios.png)![icon-android](/assets/images/site/icon-android.png) **{% data variables.android-values.routing_attr_allow_private_name %}** (allow access to private areas) | **turn on/off** |||
|   |✔   |✔ |✔ ||
|![icon-ios](/assets/images/site/icon-ios.png)![icon-android](/assets/images/site/icon-android.png) **{% data variables.android-values.routing_attr_height_obstacles_name %}** (routing could avoid strong uphills)| **turn on/off**     |||
...
|![icon-ios](/assets/images/site/icon-ios.png)![icon-android](/assets/images/site/icon-android.png) **{% data variables.android-values.temporary_conditional_routing %}** (use road restrictions that are active now on the map)|**turn on/off**|||
|   |  ✔ |✔|✔|
|![icon-android](/assets/images/site/icon-android.png) **{% data variables.android-values.fast_route_mode %}** (enable to calculate fastest route or for fuel-saving route)|**turn on/off**|||
|   |  - |✔|✔|
| ![icon-ios](/assets/images/site/icon-ios.png)![icon-android](/assets/images/site/icon-android.png) **{% data variables.android-values.routing_attr_driving_style_name %}** |**choose from the list**  ||  |
...
| ![icon-ios](/assets/images/site/icon-ios.png)![icon-android](/assets/images/site/icon-android.png) **{% data variables.android-values.routing_attr_allow_motorway_name %}** | **turn on/off** |  |  |
|   | -  |  ✔ |  - |   
