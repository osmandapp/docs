...
| <span style="color:grey", style="text-decoration:underline">"{% data variables.ios-values.recalculate_route %}"</span> |  {% data variables.ios-values.route_recalculation_descr %}    |              |
