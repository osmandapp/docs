...
|:------------|:---------------|:---------------|
|**{% data variables.android-values.nav_type_hint %}:**| {% data variables.android-values.elect_nav_profile_dialog_message %} |     |
...
| {% data variables.android-values.shared_string_online %} |  allows setting routing for any cases and showing additional info about roads.   |   List of online routing providers. Here you can add online routing engine ([Graphhopper](https://graphhopper.com/), [OSRM](http://project-osrm.org/), [Openrouteservice](https://openrouteservice.org/), GPX   |
