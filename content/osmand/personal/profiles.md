...
| <span style="color:red">"{% data variables.ios-values.recalculate_route %}"</span>  |  {% data variables.ios-values.route_recalculation_descr %}    |              |
| ["{% data variables.ios-values.recalculate_wrong_dir %}"](#39ffaf)   |  The route will be recalculated if you are moving to the start point.   |              |
