...
| **Include heading** | If enabled, the heading as the direction of movement is saved into the GPX file for every point. |
...
| `ele` | **Elevation** is the hight of the point above the sea. |
| `time` | **Timestamp** is the date and time of when the point was recorded. |
| `speed` | **Speed** is the rate at which the user is detected to be moving. |
| `heading` | **Heading** is the direction of movement. |
